...
//        update.setMessage(message);
//        telegramBot.onUpdateReceived(update);
//        assertEquals(menuBuilders.inlineMenuBuilder(chat.getId(), "Главное меню", MenuConstants.mainMenuList),
...
//                MenuConstants.mainMenu_MyCategories.getOptionName()
//                        + MenuConstants.DELIMETER
...
//        message.setMessageId(i++);
//        callbackQuery.setData(
//                MenuConstants.categoriesMenu_NewCategory.getOptionName()
//                        + MenuConstants.DELIMETER
