...
public enum ServiceState {
    ...
    EDIT_BANK_CARD__AWAITING_BANK_NAME, EDIT_BANK_CARD__AWAITING_BANK_CARD_NAME, DELETE_CHANCE__AWAITING_CHANCE_ID, EDIT_CAT__AWAITING_CAT_NAME, NEW_FEEDBACK__AWATING_MESSAGE, NEW_CHANCE__AWAITING_RATE
