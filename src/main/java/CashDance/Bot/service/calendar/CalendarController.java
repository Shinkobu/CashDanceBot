package CashDance.Bot.service.calendar;

import CashDance.Bot.service.calendar.utils.DateChoiceText;
...
public class CalendarController {
    ...
    public SendMessage startCalendar(String chatId, String calendarMessage) {
...
//        }
    ...
    public EditMessageReplyMarkup control(CallbackQuery callbackQuery) {
        // Handle callback data
        String callbackData = callbackQuery.getData();
...
//        }
    ...
    private List<List<InlineKeyboardButton>> generateMonthCalendar(LocalDate date) {
        ...
        calendar.add(InlineCalendar.createYearAndMonthRow(date, Locale.RU));
        calendar.add(InlineCalendar.createDayOfWeekRow(Locale.RU));
    ...
    private List<List<InlineKeyboardButton>> generateYearCalendar(LocalDate date) {
        return InlineCalendar.createMonthKeyboard(date, Locale.RU);
    }
